...
public class MsgKeyMapping {
    ...
    public MsgKeyMapping() {
        ...
        this.keyMapping = new KeyMapping("QM" + keyCode.getValue(), keyCode.getValue(),
                "keygroup.quickmessages.mono");
        this.msg = "";
    }
    ...
    public void checkDuplicated(InputConstants.Key oldKeyCode) {
        if (keyCode == InputConstants.UNKNOWN) {
            if (oldKeyCode != InputConstants.UNKNOWN) {
                ...
                this.keyMapping = new KeyMapping("QM" + InputConstants.UNKNOWN.getValue(),
                        InputConstants.UNKNOWN.getValue(), "keygroup.quickmessages.mono");
            }
        }
        else {
            ...
            if (duplicate) {
                ...
                KeyMapping.ALL.remove(keyMapping.getName());
                KeyMapping.resetMapping();
                this.keyMapping = new KeyMapping("QM" + keyCode.getValue(),
                        keyCode.getValue(), "keygroup.quickmessages.mono");
            }
        }
    }
}
